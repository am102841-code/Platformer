        ...
        # Creator Page 
          ...
          if exit_button.hitbox.collidepoint((mouse_x, mouse_y)) and mouseClicked:
            ...
            if level == 2 and level_changing:
                ...
                ob5 = pygame.Rect(650/2 - 250 - 75, 650/2 - 70, 50, 50) # secret level block
            ...
            if level == 3 and level_changing == True:
                ...
                ob2 = pygame.Rect(450, 290, 50, 50) # grey 
                ob3 = pygame.Rect(330, 175, 50, 50) # grey 
                ...
                coin_list = []
                spike_position_list = [spike1, spike2] 
                obstacle_list = [ob1,ob4, ground]
                small_obstacle_list = [ob2, ob3]
                ...
                horizontal_collision(player, small_obstacle_list) 
            ...
            # Vertical Collision
            player.on_ground = False
            for x in obstacle_list + small_obstacle_list:
                if player.hitbox.colliderect(x):
            ...
            for x in small_obstacle_list: 
                pygame.draw.rect(WINDOW, (192, 192, 192), x)
                #small_platform_img = pygame.transform.scale(x, ())
